...
export const initIO = (httpServer: Server): SocketIO => {
  ...
  workspaces.on("connection", socket => {
    ...
    // ✅ presenceSubscribe: quando atendente abre um ticket, subscribir na presença do contato
    socket.on("presenceSubscribe", async (data: { contactNumber: string; whatsappId: number; isGroup: boolean }) => {
      try {
