  ...
  const ticket = await Ticket.findOne({
    ...
    include: [
      ...
      },
      {
        model: Whatsapp,
        as: "whatsapp",
        attributes: ["id", "name", "groupAsTicket", "greetingMediaAttachment", "facebookUserToken", "facebookUserId", "status", "token", "channel", "color", "phone_number_id", "tokenMeta", "send_token", "waba_id"]
