...
const MessagesList = ({
  ...
  const scrollToBottom = () => {
    ...
    // Tenta múltiplas vezes para garantir que o DOM renderizou
  ...
  const checkMessageMedia = (message) => {
    ...
    // Documentos genéricos (ZIP, RAR, DOC, XLS, etc.)
              ...
              >
                ...
                <div className={clsx(classes.textContentItem, {
                  ...
                  )}
                  {
                    ...
                    message.mediaType !== "buttonsResponseMessage" && message.mediaType !== "messageContextInfo" && (
